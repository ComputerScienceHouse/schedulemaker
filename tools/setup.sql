...
--
-- Host: localhost
-- Generation Time: Oct 06, 2011 at 11:21 AM
...
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=57730 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=1229434 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=386437 ;
...
CREATE TABLE IF NOT EXISTS `schedules` (
  ...
  `datelastaccessed` timestamp NOT NULL default '0000-00-00 00:00:00' on update CURRENT_TIMESTAMP,
  ...
  PRIMARY KEY  (`id`),
  KEY `oldid` (`oldid`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=234270 ;
