						...
						<div class="panel-body">
							<div class="row form-inline">
								<div class="col-xs-12">
									...
									<div class="form-group pull-right" schedule-pagination="state.displayOptions"></div>
								</div>
							</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<div class="center" schedule-pagination="state.displayOptions" schedule-pagination-callback="scrollToSchedules()"></div>
						</div>
					</div>
				</div>
			</div>
