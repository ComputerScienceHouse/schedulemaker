...
app.controller("GenerateController", function($scope, globalKbdShortcuts, $http, $filter, localStorage, uiDayFactory) {
...
app.controller( "scheduleCoursesController", function( $scope, $http, $q, $timeout) {
...
app.controller('nonCourseItemsController', function($scope) {
...
app.controller('noCourseItemsController', function($scope) {
...
app.controller("ScheduleViewController", function($scope, $location, $stateParams) {
...
app.controller("SchedulePrintController", function($scope, $location, localStorage) {
...
// BROWSE PAGE
app.controller("BrowseController", function($scope, entityDataRequest) {
 ...
 */
app.controller('SearchController', function($scope, $http, entityDataRequest, globalKbdShortcuts) {
