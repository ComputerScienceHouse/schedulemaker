...
<div class="container">
	...
	<div class="alert alert-success alert-dismissable hidden-xs" ng-show="state.ui.alert_newFeatures">
		...
		Welcome to the new ScheduleMaker! We've added lots of new functionality to the website, including full mobile support, a brand-new interface, a new course cart and search system, and RateMyProfessors integration. Enjoy!
	</div>
